...
function foodie_theme_setup() {
	...
	add_filter( 'genesis_search_text', 'foodie_search_text' );
...
function foodie_read_more_link() {
	return '<p></p><a class="more-link" href="' . get_permalink() . '">' . __( 'Read More', 'foodie' ) . ' &raquo;</a>';
}
 ...
 *
 * @param  string $text
 * @return string Modified search text.
 *
 * @since  1.0.0
 */
function foodie_search_text( $text ) {
	return __( 'looking for something?', 'foodie' );
}
