	...
	<div class="form-wrap">
		...
		foreach($meta_boxes_homepage_section as $meta_box) {
			...
			<?php } else if($meta_box[ 'name' ]=='section_layout') { ?>
				<div class="form-field">
					<label for="<?php echo $meta_box[ 'name' ]; ?>">colour</label>
					<select id="<?php echo $meta_box[ 'name' ]; ?>" name="<?php echo $meta_box[ 'name' ]; ?>" style="min-width:200px;">
						<option value="default" <?php if(isset($data[$meta_box['name']])) selected($data[$meta_box['name']],'red'); ?>>red</option>
						<option value="contact" <?php if(isset($data[$meta_box['name']])) selected($data[$meta_box['name']],'blue'); ?>>blue</option>
						<option value="contact" <?php if(isset($data[$meta_box['name']])) selected($data[$meta_box['name']],'gray'); ?>>gray</option>
						<option value="contact" <?php if(isset($data[$meta_box['name']])) selected($data[$meta_box['name']],'darkturquoise'); ?>>darkturquoise</option>
					</select>
					<p><?php echo $meta_box[ 'description' ]; ?></p>
				</div>
			<?php }
