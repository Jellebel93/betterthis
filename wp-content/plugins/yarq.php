...
function yarq_admin_options()
{
	...
	echo '<p><input type="checkbox" id="yarq_autoformat" name="yarq_autoformat" class="code" value="1"' . 
	     "$chk /> Autoformat quotes. (The plugin will try adding paragraphs &lt;p&gt; and line breaks &lt;br /&gt; where they make sense. This won't work so well with &lt;ul&gt; and &lt;ol&gt;, among other things. This will only apply to adding or editing quotes.)</p>\n";	
	echo "</fieldset>\n";
...
{
	echo yarq_get($format);
}

function yarq_get($format = '') {
	global $wpdb;
